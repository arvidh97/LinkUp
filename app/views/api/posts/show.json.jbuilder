...
json.author do
  ...
  json.lName @post.author.lname
  json.title @post.author.title
  json.photoUrl @post.author.photo.attached? ? rails_blob_url(@post.author.photo) : nil
end
json.likes do
  @post.likes.each do |like|
    json.set! like.id.to_s do
      ...
      json.liker do
        ...
        json.lName like.liker.lname
        json.title like.liker.title
        json.photoUrl like.liker.photo.attached? ? rails_blob_url(like.liker.photo) : nil
      end
    end
  end
end
  ...
  @post.comments.each do |comment| 
    json.set!(comment.id.to_s) do 
      ...
      json.author do
        ...
        json.lName comment.author.lname
        json.title comment.author.title
        json.photoUrl comment.author.photo.attached? ? rails_blob_url(comment.author.photo) : nil
      end
    end
  end
end
